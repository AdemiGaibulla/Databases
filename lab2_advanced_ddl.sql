...
CREATE TABLE patient_admissions(
    ...
    room_assigned VARCHAR(15),
    insurance_verified BOOLEAN,
    critical_status BOOLEAN
);
...
CREATE TABLE medical_treatments(
    ...
    treatment_start TIME WITHOUT TIME ZONE,
    treatment_duration INTERVAL,
    medication_cost NUMERIC(4,2),
    treatment_completed	BOOLEAN,
    follow_up_required BOOLEAN,
    priority_level SMALLINT
);

ALTER TABLE patient_admissions ADD COLUMN department_id INTEGER
